...
""", xml)
    ...
    def roundtrip_xml(self, xml_in, root='statement'):
        ...
        doc = StructuredDocument.for_document_type(root)(xml_out)
        assert_validates(doc, strict=False)

    def test_eids_against_js(self):
        # should not change a document with correct eids (see bluebell-monaco/tests/eids.js)
        xml = f'''<akomaNtoso xmlns="http://docs.oasis-open.org/legaldocml/ns/akn/3.0">
