...
class Grammar(object):
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if address4 is not FAILURE:
                    elements2.append(address4)
                    address5 = FAILURE
                    address5 = self._read_preface_block_element()
                    if address5 is not FAILURE:
                        elements2.append(address5)
                    else:
                        elements2 = None
    ...
    def _read_preface_block(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['preface_block'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1, elements0 = self._offset, []
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                address3 = self._read_preface_block_element()
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
            if remaining0 <= 0:
        ...
        self._cache['preface_block'][index0] = (address0, self._offset)
        return address0

    def _read_preface_block_element(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['preface_block_element'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1 = self._offset
        address0 = self._read_preface_block()
        if address0 is FAILURE:
            ...
            if address0 is FAILURE:
                ...
                if address0 is FAILURE:
                    self._offset = index1
        self._cache['preface_block_element'][index0] = (address0, self._offset)
        return address0
                        ...
                        if address5 is not FAILURE:
                            ...
                            while address7 is not FAILURE:
                                ...
                                if address8 is not FAILURE:
                                    elements2.append(address8)
                                    address9 = FAILURE
                                    address9 = self._read_hier_content()
                                    if address9 is not FAILURE:
                                        elements2.append(address9)
                                    else:
                                        elements2 = None
                                ...
                                if elements2 is None:
                                    ...
                                    address7 = TreeNode26(self._input[index5:self._offset], index5, elements2)
                                    self._offset = self._offset
                                if address7 is not FAILURE:
        ...
        if address1 is not FAILURE:
            ...
            if address2 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address4 = TreeNode28(self._input[index4:self._offset], index4, elements2)
                    self._offset = self._offset
                if address4 is FAILURE:
    ...
    def _read_hier_content(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['hier_content'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1 = self._offset
        ...
        if address0 is FAILURE:
            ...
            if address0 is FAILURE:
                self._offset = index1
        self._cache['hier_content'][index0] = (address0, self._offset)
        return address0
        ...
        if address1 is not FAILURE:
            ...
            if address6 is FAILURE:
                ...
                if elements3 is None:
                    ...
                    address6 = TreeNode32(self._input[index6:self._offset], index6, elements3)
                    self._offset = self._offset
                if address6 is FAILURE:
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address3 = TreeNode39(self._input[index3:self._offset], index3, elements2)
                    self._offset = self._offset
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address3 = TreeNode41(self._input[index3:self._offset], index3, elements2)
                    self._offset = self._offset
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
