...
class TreeNode2(TreeNode):
    def __init__(self, text, offset, elements):
        ...
        self.hier_element_name = elements[1]
        self.hier_element_num = elements[2]
        self.eol = elements[3]
        self.indent = elements[4]
        self.children = elements[5]
...
class Grammar(object):
    ...
    def _read_hier_element(self):
        ...
        if address1 is not FAILURE:
            elements0.append(address1)
            address2 = FAILURE
            address2 = self._read_hier_element_name()
            if address2 is not FAILURE:
                elements0.append(address2)
                address3 = FAILURE
                index3 = self._offset
                address3 = self._read_hier_element_num()
                    ...
                    if address4 is not FAILURE:
                        ...
                        if address5 is not FAILURE:
                            ...
                            while address7 is not FAILURE:
                                index5 = self._offset
                                address7 = self._read_hier_element()
    ...
    def _read_block_element(self):
        ...
        if address1 is not FAILURE:
            ...
            if address2 is not FAILURE:
                ...
                address3 = FAILURE
                index4 = self._offset
                address3 = self._read_table()
                if address3 is FAILURE:
                    self._offset = index4
                    address3 = self._read_line()
                    if address3 is FAILURE:
                        self._offset = index4
                if address3 is not FAILURE:
                    elements0.append(address3)
