...
class TreeNode10(TreeNode):
    def __init__(self, text, offset, elements):
        ...
        self.dotted_num = elements[0]
        self.intro = elements[2]
        self.eol = elements[3]
...
class TreeNode57(TreeNode):
    def __init__(self, text, offset, elements):
        ...
        self.table_start = elements[0]
        self.table_body = elements[1]
        self.table_end = elements[2]
...
class Grammar(object):
    ...
    REGEX_3 = re.compile('^[0-9a-zA-Z]')
    REGEX_4 = re.compile('^[^)]')
    REGEX_5 = re.compile('^[!|]')
    REGEX_6 = re.compile('^[a-z_-]')
    REGEX_7 = re.compile('^[^ \\n]')
    REGEX_8 = re.compile('^[^\\n]')
    REGEX_9 = re.compile('^[^\\n]')
    REGEX_10 = re.compile('^[^)\\n]')
    ...
    def _read_hier_element(self):
        ...
        if address0 is FAILURE:
            self._offset = index1
            address0 = self._read_implicit_hier_element()
            if address0 is FAILURE:
                self._offset = index1
    ...
    def _read_implicit_hier_element(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['implicit_hier_element'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1, elements0 = self._offset, []
        address1 = FAILURE
        address1 = self._read_dotted_num()
        if address1 is not FAILURE:
            elements0.append(address1)
            address2 = FAILURE
            chunk0, max0 = None, self._offset + 1
            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    if address7 is not FAILURE:
                        ...
                        address9 = FAILURE
                        address9 = self._read_indent()
                        if address9 is not FAILURE:
                            elements3.append(address9)
                            address10 = FAILURE
                            remaining1, index7, elements4, address11 = 0, self._offset, [], True
                            while address11 is not FAILURE:
                                ...
                                if address11 is not FAILURE:
                                    ...
                                    remaining1 -= 1
                            if remaining1 <= 0:
                                address10 = TreeNode(self._input[index7:self._offset], index7, elements4)
                                self._offset = self._offset
                            else:
                                address10 = FAILURE
                        ...
                        if elements3 is None:
                            ...
                            address8 = TreeNode12(self._input[index6:self._offset], index6, elements3)
                            self._offset = self._offset
        ...
        if address0 is not FAILURE:
            cls0 = type(address0)
            address0.__class__ = type(cls0.__name__ + 'ImplicitHierElement', (cls0, self._types.ImplicitHierElement), {})
        self._cache['implicit_hier_element'][index0] = (address0, self._offset)
        return address0

    def _read_dotted_num(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['dotted_num'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1, elements0 = self._offset, []
                ...
                if address4 is not FAILURE:
                    ...
                    if chunk2 is not None and Grammar.REGEX_3.search(chunk2):
                        ...
                        if self._offset > self._failure:
                            ...
                            self._expected = []
                        if self._offset == self._failure:
                            self._expected.append('[0-9a-zA-Z]')
                    if address5 is not FAILURE:
                        elements2.append(address5)
                    else:
                        elements2 = None
        ...
        if elements0 is None:
            ...
            self._offset = self._offset
        self._cache['dotted_num'][index0] = (address0, self._offset)
        return address0
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address3 = TreeNode18(self._input[index4:self._offset], index4, elements2)
                    self._offset = self._offset
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address3 = TreeNode20(self._input[index4:self._offset], index4, elements2)
                    self._offset = self._offset
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    if elements1 is None:
                        ...
                        address4 = TreeNode36(self._input[index4:self._offset], index4, elements1)
                        self._offset = self._offset
                    if address4 is FAILURE:
                        address4 = TreeNode(self._input[index3:index3], index3, [])
                        self._offset = index3
                    if address4 is not FAILURE:
                        ...
                        while address11 is not FAILURE:
                            ...
                            if elements4 is None:
                                ...
                                address11 = TreeNode37(self._input[index8:self._offset], index8, elements4)
                                self._offset = self._offset
                            if address11 is not FAILURE:
        ...
        if address1 is not FAILURE:
            ...
            if address6 is FAILURE:
                ...
                if elements3 is None:
                    ...
                    address6 = TreeNode51(self._input[index6:self._offset], index6, elements3)
                    self._offset = self._offset
                if address6 is FAILURE:
                    address6 = TreeNode(self._input[index5:index5], index5, [])
                    self._offset = index5
            ...
            if address6 is not FAILURE:
                ...
                if elements4 is None:
                    ...
                    address10 = TreeNode52(self._input[index9:self._offset], index9, elements4)
                    self._offset = self._offset
                if address10 is FAILURE:
    ...
    def _read_table(self):
        ...
        index1, elements0 = self._offset, []
        address1 = FAILURE
        address1 = self._read_table_start()
        if address1 is not FAILURE:
            elements0.append(address1)
            address2 = FAILURE
            address2 = self._read_table_body()
            if address2 is not FAILURE:
                elements0.append(address2)
                address3 = FAILURE
                address3 = self._read_table_end()
                if address3 is not FAILURE:
                    elements0.append(address3)
                else:
                    elements0 = None
    ...
    def _read_table_start(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['table_start'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1, elements0 = self._offset, []
        ...
        if elements0 is None:
            ...
            self._offset = self._offset
        self._cache['table_start'][index0] = (address0, self._offset)
        return address0

    def _read_table_body(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['table_body'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        ...
        while address1 is not FAILURE:
            index2 = self._offset
            address1 = self._read_table_row()
            if address1 is FAILURE:
                self._offset = index2
                address1 = self._read_table_cell()
                if address1 is FAILURE:
                    self._offset = index2
            if address1 is not FAILURE:
                elements0.append(address1)
        ...
        if remaining0 <= 0:
            ...
            address0 = FAILURE
        self._cache['table_body'][index0] = (address0, self._offset)
        return address0
    ...
    def _read_table_cell(self):
        ...
        if address1 is not FAILURE:
            ...
            if address2 is not FAILURE:
                ...
                address3 = FAILURE
                index3 = self._offset
                address3 = self._read_table_attribs()
                if address3 is FAILURE:
                    address3 = TreeNode(self._input[index3:index3], index3, [])
                    self._offset = index3
                if address3 is not FAILURE:
    ...
    def _read_table_cell_start(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['table_cell_start'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        chunk0, max0 = None, self._offset + 1
    ...
    def _read_table_attribs(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['table_attribs'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1, elements0 = self._offset, []
        ...
        if address1 is not FAILURE:
            ...
            remaining0, index3, elements1, address3 = 1, self._offset, [], True
            while address3 is not FAILURE:
                address3 = self._read_table_attrib()
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
            if remaining0 <= 0:
        ...
        if address0 is not FAILURE:
            cls0 = type(address0)
            address0.__class__ = type(cls0.__name__ + 'TableAttribs', (cls0, self._types.TableAttribs), {})
        self._cache['table_attribs'][index0] = (address0, self._offset)
        return address0

    def _read_table_attrib(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['table_attrib'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1, elements0 = self._offset, []
            ...
            if address3 is not FAILURE:
                ...
                if address4 is FAILURE:
                    ...
                    if address11 is not FAILURE:
                        ...
                        address12 = FAILURE
                        remaining2, index9, elements6, address13 = 0, self._offset, [], True
                        while address13 is not FAILURE:
                            ...
                            if elements7 is None:
                                ...
                                address13 = TreeNode(self._input[index10:self._offset], index10, elements7)
                                self._offset = self._offset
                            if address13 is not FAILURE:
                                elements6.append(address13)
                                remaining2 -= 1
                        if remaining2 <= 0:
                            address12 = TreeNode(self._input[index9:self._offset], index9, elements6)
                            self._offset = self._offset
                        else:
                            address12 = FAILURE
                        if address12 is not FAILURE:
                    ...
                    if elements5 is None:
                        ...
                        address4 = TreeNode(self._input[index8:self._offset], index8, elements5)
                        self._offset = self._offset
                    if address4 is FAILURE:
                        self._offset = index3
                if address4 is not FAILURE:
                    ...
                    address17 = self._read_space()
                    if address17 is FAILURE:
                        address17 = TreeNode(self._input[index12:index12], index12, [])
        ...
        if elements0 is None:
            ...
            self._offset = self._offset
        self._cache['table_attrib'][index0] = (address0, self._offset)
        return address0

    def _read_table_end(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['table_end'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1, elements0 = self._offset, []
        ...
        if elements0 is None:
            ...
            self._offset = self._offset
        self._cache['table_end'][index0] = (address0, self._offset)
        return address0
            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    while address5 is not FAILURE:
                        address5 = self._read_hier_block_element()
                        if address5 is not FAILURE:
                            elements1.append(address5)
                            remaining0 -= 1
                    if remaining0 <= 0:
            ...
            if address2 is not FAILURE:
                ...
                if address6 is not FAILURE:
                    ...
                    while address8 is not FAILURE:
                        ...
                        if max4 <= self._input_size:
                            chunk4 = self._input[self._offset:max4]
                        if chunk4 is not None and Grammar.REGEX_10.search(chunk4):
                            address8 = TreeNode(self._input[self._offset:self._offset + 1], self._offset, [])
                            self._offset = self._offset + 1
                        else:
                            address8 = FAILURE
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address3 = TreeNode70(self._input[index3:self._offset], index3, elements2)
                    self._offset = self._offset
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address3 = TreeNode72(self._input[index3:self._offset], index3, elements2)
                    self._offset = self._offset
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address3 = TreeNode78(self._input[index3:self._offset], index3, elements2)
                    self._offset = self._offset
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address3 = TreeNode80(self._input[index3:self._offset], index3, elements2)
                    self._offset = self._offset
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
            ...
            if address2 is not FAILURE:
                ...
                if address6 is not FAILURE:
                    ...
                    while address8 is not FAILURE:
                        ...
                        if max4 <= self._input_size:
                            chunk4 = self._input[self._offset:max4]
                        if chunk4 is not None and Grammar.REGEX_12.search(chunk4):
                            address8 = TreeNode(self._input[self._offset:self._offset + 1], self._offset, [])
                            self._offset = self._offset + 1
                        else:
                            address8 = FAILURE
