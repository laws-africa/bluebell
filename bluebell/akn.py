            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    if address5 is not FAILURE:
                        ...
                        if address6 is not FAILURE:
                            ...
                            if address7 is not FAILURE:
                                ...
                                address9 = FAILURE
                                index7 = self._offset
                                address9 = self._read_attachments()
                                if address9 is FAILURE:
                    ...
                    if address4 is not FAILURE:
                        elements0.append(address4)
                        address11 = FAILURE
                        remaining1, index8, elements3, address12 = 0, self._offset, [], True
                        while address12 is not FAILURE:
                            index9, elements4 = self._offset, []
                            address13 = FAILURE
                            index10 = self._offset
                            address13 = self._read_attachment_marker()
                            self._offset = index10
                            ...
                            if address13 is not FAILURE:
                                ...
                                address14 = FAILURE
                                address14 = self._read_hier_block_indent()
                            ...
                            if elements4 is None:
                                ...
                                address12 = TreeNode34(self._input[index9:self._offset], index9, elements4)
                                self._offset = self._offset
                            if address12 is not FAILURE:
                                elements3.append(address12)
                                remaining1 -= 1
                        if remaining1 <= 0:
                            address11 = TreeNode(self._input[index8:self._offset], index8, elements3)
                            self._offset = self._offset
                        else:
                            address11 = FAILURE
                        if address11 is not FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    while address5 is not FAILURE:
                        ...
                        if elements2 is None:
                            ...
                            address5 = TreeNode66(self._input[index5:self._offset], index5, elements2)
                            self._offset = self._offset
                        if address5 is not FAILURE:
                            elements1.append(address5)
                            remaining0 -= 1
            ...
            if address2 is not FAILURE:
                ...
                while address4 is not FAILURE:
                    ...
                    if elements2 is None:
                        ...
                        address4 = TreeNode83(self._input[index3:self._offset], index3, elements2)
                        self._offset = self._offset
                    if address4 is not FAILURE:
                        elements1.append(address4)
                        remaining0 -= 1
                    ...
                    if address7 is not FAILURE:
                        ...
                        while address9 is not FAILURE:
                            ...
                            if elements4 is None:
                                ...
                                address9 = TreeNode87(self._input[index7:self._offset], index7, elements4)
                                self._offset = self._offset
                            if address9 is not FAILURE:
                                elements3.append(address9)
                                remaining1 -= 1
                    ...
                    if address4 is not FAILURE:
                        ...
                        while address6 is not FAILURE:
                            ...
                            if elements2 is None:
                                ...
                                address6 = TreeNode90(self._input[index5:self._offset], index5, elements2)
                                self._offset = self._offset
                            if address6 is not FAILURE:
                                elements1.append(address6)
                                remaining0 -= 1
