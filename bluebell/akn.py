...
class TreeNode83(TreeNode):
    def __init__(self, text, offset, elements):
        ...
        self.inline_end_remark = elements[1]
...
class Grammar(object):
                        ...
                        if address6 is not FAILURE:
                            ...
                            while address8 is not FAILURE:
                                ...
                                if elements3 is None:
                                    ...
                                    address8 = TreeNode34(self._input[index7:self._offset], index7, elements3)
                                    self._offset = self._offset
                                if address8 is not FAILURE:
                                    elements2.append(address8)
                                    remaining0 -= 1
                    ...
                    if address4 is not FAILURE:
                        ...
                        while address14 is not FAILURE:
                            ...
                            if elements5 is None:
                                ...
                                address14 = TreeNode35(self._input[index11:self._offset], index11, elements5)
                                self._offset = self._offset
            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    if elements1 is None:
                        ...
                        address4 = TreeNode57(self._input[index4:self._offset], index4, elements1)
                        self._offset = self._offset
                    if address4 is FAILURE:
                        address4 = TreeNode(self._input[index3:index3], index3, [])
                        self._offset = index3
        ...
        if address1 is not FAILURE:
            ...
            if address4 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address5 = TreeNode60(self._input[index7:self._offset], index7, elements2)
                    self._offset = self._offset
                if address5 is FAILURE:
                    address5 = TreeNode(self._input[index6:index6], index6, [])
                    self._offset = index6
            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    if elements1 is None:
                        ...
                        address4 = TreeNode64(self._input[index5:self._offset], index5, elements1)
                        self._offset = self._offset
                    if address4 is FAILURE:
                        address4 = TreeNode(self._input[index4:index4], index4, [])
                        self._offset = index4
                ...
                if address3 is not FAILURE:
                    ...
                    while address5 is not FAILURE:
                        ...
                        if elements2 is None:
                            ...
                            address5 = TreeNode67(self._input[index5:self._offset], index5, elements2)
                            self._offset = self._offset
                        if address5 is not FAILURE:
                            elements1.append(address5)
                            remaining0 -= 1
        ...
        if address0 is FAILURE:
            ...
            if address0 is FAILURE:
                ...
                if elements1 is None:
                    ...
                    address0 = TreeNode72(self._input[index4:self._offset], index4, elements1)
                    self._offset = self._offset
                if address0 is FAILURE:
                    self._offset = index3
                    chunk2, max2 = None, self._offset + 1
    ...
    def _read_inline_end_remark(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['inline_end_remark'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1 = self._offset
        ...
        if address0 is FAILURE:
            ...
            if address0 is FAILURE:
                ...
                if elements1 is None:
                    ...
                    address0 = TreeNode73(self._input[index4:self._offset], index4, elements1)
                    self._offset = self._offset
                if address0 is FAILURE:
                    self._offset = index3
                    chunk2, max2 = None, self._offset + 1
                ...
                if address0 is FAILURE:
                    self._offset = index1
        self._cache['inline_end_remark'][index0] = (address0, self._offset)
        return address0
    ...
    def _read_strikethrough(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['strikethrough'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1, elements0 = self._offset, []
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address3 = TreeNode81(self._input[index3:self._offset], index3, elements2)
                    self._offset = self._offset
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
        ...
        if address0 is not FAILURE:
            cls0 = type(address0)
            address0.__class__ = type(cls0.__name__ + 'Strikethrough', (cls0, self._types.Strikethrough), {})
        self._cache['strikethrough'][index0] = (address0, self._offset)
        return address0
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if address4 is not FAILURE:
                    elements2.append(address4)
                    address5 = FAILURE
                    address5 = self._read_inline_end_remark()
                    if address5 is not FAILURE:
                        elements2.append(address5)
                    else:
                        elements2 = None
                ...
                if elements2 is None:
                    ...
                    address3 = TreeNode83(self._input[index3:self._offset], index3, elements2)
                    self._offset = self._offset
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
            ...
            if address2 is not FAILURE:
                ...
                while address4 is not FAILURE:
                    ...
                    if elements2 is None:
                        ...
                        address4 = TreeNode86(self._input[index3:self._offset], index3, elements2)
                        self._offset = self._offset
                    if address4 is not FAILURE:
                        elements1.append(address4)
                        remaining0 -= 1
            ...
            if address2 is not FAILURE:
                ...
                while address4 is not FAILURE:
                    ...
                    if elements2 is None:
                        ...
                        address4 = TreeNode88(self._input[index3:self._offset], index3, elements2)
                        self._offset = self._offset
                    if address4 is not FAILURE:
                        elements1.append(address4)
                        remaining0 -= 1
                    ...
                    if address7 is not FAILURE:
                        ...
                        while address9 is not FAILURE:
                            ...
                            if elements4 is None:
                                ...
                                address9 = TreeNode90(self._input[index7:self._offset], index7, elements4)
                                self._offset = self._offset
                            if address9 is not FAILURE:
                                elements3.append(address9)
                                remaining1 -= 1
                ...
                if address3 is not FAILURE:
                    ...
                    while address5 is not FAILURE:
                        ...
                        if address6 is not FAILURE:
                            ...
                            if max1 <= self._input_size:
                                chunk1 = self._input[self._offset:max1]
                            if chunk1 is not None and Grammar.REGEX_16.search(chunk1):
                                address7 = TreeNode(self._input[self._offset:self._offset + 1], self._offset, [])
                                self._offset = self._offset + 1
                            else:
                                address7 = FAILURE
