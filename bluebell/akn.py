...
class Grammar(object):
    ...
    def _read_nested_attachments(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['nested_attachments'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1, elements0 = self._offset, []
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                address3 = self._read_attachment()
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
            if remaining0 <= 0:
        ...
        if address0 is not FAILURE:
            cls0 = type(address0)
            address0.__class__ = type(cls0.__name__ + 'NestedAttachments', (cls0, self._types.NestedAttachments), {})
        self._cache['nested_attachments'][index0] = (address0, self._offset)
        return address0
            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                        ...
                        if address6 is not FAILURE:
                            ...
                            while address8 is not FAILURE:
                                ...
                                if elements3 is None:
                                    ...
                                    address8 = TreeNode35(self._input[index7:self._offset], index7, elements3)
                                    self._offset = self._offset
                                if address8 is not FAILURE:
                                    elements2.append(address8)
                                    remaining0 -= 1
                    ...
                    if elements1 is None:
                        ...
                        address4 = TreeNode34(self._input[index4:self._offset], index4, elements1)
                        self._offset = self._offset
                    if address4 is FAILURE:
                        address4 = TreeNode(self._input[index3:index3], index3, [])
                        self._offset = index3
                    if address4 is not FAILURE:
                        ...
                        while address14 is not FAILURE:
                            ...
                            if elements5 is None:
                                ...
                                address14 = TreeNode36(self._input[index11:self._offset], index11, elements5)
                                self._offset = self._offset
                        ...
                        if address13 is not FAILURE:
                            ...
                            address17 = self._read_nested_attachments()
                            if address17 is FAILURE:
                                address17 = TreeNode(self._input[index13:index13], index13, [])
            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    if elements1 is None:
                        ...
                        address4 = TreeNode58(self._input[index4:self._offset], index4, elements1)
                        self._offset = self._offset
                    if address4 is FAILURE:
                        address4 = TreeNode(self._input[index3:index3], index3, [])
                        self._offset = index3
        ...
        if address1 is not FAILURE:
            ...
            if address4 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address5 = TreeNode61(self._input[index7:self._offset], index7, elements2)
                    self._offset = self._offset
                if address5 is FAILURE:
                    address5 = TreeNode(self._input[index6:index6], index6, [])
                    self._offset = index6
            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    if elements1 is None:
                        ...
                        address4 = TreeNode65(self._input[index5:self._offset], index5, elements1)
                        self._offset = self._offset
                    if address4 is FAILURE:
                        address4 = TreeNode(self._input[index4:index4], index4, [])
                        self._offset = index4
                ...
                if address3 is not FAILURE:
                    ...
                    while address5 is not FAILURE:
                        ...
                        if elements2 is None:
                            ...
                            address5 = TreeNode68(self._input[index5:self._offset], index5, elements2)
                            self._offset = self._offset
                        if address5 is not FAILURE:
                            elements1.append(address5)
                            remaining0 -= 1
    ...
    def _read_block_attr(self):
        ...
        if address1 is not FAILURE:
            ...
            if elements1 is None:
                ...
                address2 = TreeNode70(self._input[index3:self._offset], index3, elements1)
                self._offset = self._offset
            if address2 is FAILURE:
                address2 = TreeNode(self._input[index2:index2], index2, [])
                self._offset = index2
        ...
        if address0 is FAILURE:
            ...
            if address0 is FAILURE:
                ...
                if elements1 is None:
                    ...
                    address0 = TreeNode74(self._input[index4:self._offset], index4, elements1)
                    self._offset = self._offset
                if address0 is FAILURE:
                    self._offset = index3
                    chunk2, max2 = None, self._offset + 1
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if elements2 is None:
                    ...
                    address3 = TreeNode82(self._input[index3:self._offset], index3, elements2)
                    self._offset = self._offset
                if address3 is not FAILURE:
                    elements1.append(address3)
                    remaining0 -= 1
            ...
            if address2 is not FAILURE:
                ...
                while address4 is not FAILURE:
                    ...
                    if elements2 is None:
                        ...
                        address4 = TreeNode85(self._input[index3:self._offset], index3, elements2)
                        self._offset = self._offset
                    if address4 is not FAILURE:
                        elements1.append(address4)
                        remaining0 -= 1
            ...
            if address2 is not FAILURE:
                ...
                while address4 is not FAILURE:
                    ...
                    if elements2 is None:
                        ...
                        address4 = TreeNode87(self._input[index3:self._offset], index3, elements2)
                        self._offset = self._offset
                    if address4 is not FAILURE:
                        elements1.append(address4)
                        remaining0 -= 1
                    ...
                    if address7 is not FAILURE:
                        ...
                        while address9 is not FAILURE:
                            ...
                            if elements4 is None:
                                ...
                                address9 = TreeNode89(self._input[index7:self._offset], index7, elements4)
                                self._offset = self._offset
                            if address9 is not FAILURE:
                                elements3.append(address9)
                                remaining1 -= 1
                    ...
                    if address4 is not FAILURE:
                        ...
                        while address6 is not FAILURE:
                            ...
                            if elements2 is None:
                                ...
                                address6 = TreeNode92(self._input[index5:self._offset], index5, elements2)
                                self._offset = self._offset
                            if address6 is not FAILURE:
                                elements1.append(address6)
                                remaining0 -= 1
